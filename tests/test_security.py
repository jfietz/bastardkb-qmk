...
class TestSecurity(unittest.TestCase):
    ...
    def test_copy_assets_prevents_arbitrary_file_read_via_symlink(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            # Create a symlink in the via_dir pointing to the sensitive file
            via_symlink = via_dir / "malicious.via.json"
            ...
            # Assert that the symlink was NOT copied to the output directory
