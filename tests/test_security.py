...
class TestSecurity(unittest.TestCase):
    ...
    def test_copy_assets_prevents_arbitrary_file_read_via_source_symlink(self):
        with tempfile.TemporaryDirectory() as td:
            td_path = Path(td)
            ...
            symlink_src = via_dir / "malicious.via.json"
            ...
            # Assert the sensitive file was NOT copied to the output directory
