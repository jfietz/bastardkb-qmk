...
class TestSecurity(unittest.TestCase):
    ...
    def test_copy_assets_prevents_arbitrary_file_read_via_symlink(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            # Create a malicious symlink in the via assets directory pointing to the sensitive file
            ...
            # Assert malicious symlink was NOT followed and copied
            copied_file = out_dir / "malicious.via.json"
            self.assertFalse(copied_file.exists(), "Malicious symlink was followed and copied, leading to arbitrary file read!")
