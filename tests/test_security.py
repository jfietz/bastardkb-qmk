...
class TestSecurity(unittest.TestCase):
    ...
    def test_copy_assets_prevents_arbitrary_file_read_via_symlink(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            # Create a symlink in the repo masquerading as a via.json file
            ...
            self.assertFalse(dst.exists(), "Arbitrary file read vulnerability: Symlink was copied to output directory!")
