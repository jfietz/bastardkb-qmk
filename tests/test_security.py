...
class TestSecurity(unittest.TestCase):
    ...
    def test_copy_assets_prevents_symlink_read_from_source(self):
        with tempfile.TemporaryDirectory() as td:
            td_path = Path(td)
            ...
            malicious_symlink = via_dir / "test_keyboard.via.json"
            ...
            # Assert the file was NOT copied to the output directory
            dst = out_dir / "test_keyboard.via.json"
