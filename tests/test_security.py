...
class TestSecurity(unittest.TestCase):
    ...
    def test_copy_assets_prevents_arbitrary_file_read_via_symlink(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            src = via_dir / "test.via.json"
            os.symlink(sensitive_file, src)
            ...
            # Assert the symlink was ignored and NOT copied to the output directory
            self.assertFalse((out_dir / "test.via.json").exists())
