...
class TestSecurity(unittest.TestCase):
    ...
    def test_copy_assets_prevents_arbitrary_file_read_via_symlink(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            # Create a malicious symlink in the source directory pointing to the sensitive file
            ...
            self.assertEqual((out_dir / "legit.via.json").read_text(), "legit content")

            # Assert the malicious symlink was ignored, meaning no file read occurred
            self.assertFalse((out_dir / "malicious.via.json").exists())
