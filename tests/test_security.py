...
class TestSecurity(unittest.TestCase):
    ...
    def test_copy_assets_prevents_arbitrary_file_read_via_symlink(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            # Create a sensitive target file outside the output directory
            sensitive_file = td_path / "sensitive_data.txt"
            sensitive_file.write_text("secret_password")

            # Create a malicious symlink in the via directory pointing to sensitive file
            ...
            # Assert malicious symlink was skipped, and the sensitive file was NOT copied
