...
# --- MOCK SETUP START ---
# We must mock rich and pygit2 BEFORE importing bastardkb_build_releases
...
# Define the MockPanel class that we want the application to use
class MockPanel:
    def __init__(self, renderable, **kwargs):
        self.renderable = renderable
        self.title = kwargs.get("title", "")

# Create a mock module for rich.panel
mock_panel_module = MagicMock()
# Assign our MockPanel class to the module's Panel attribute
mock_panel_module.Panel = MockPanel
# Inject this mock module into sys.modules
