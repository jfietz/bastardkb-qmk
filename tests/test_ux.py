...
class TestUX(unittest.TestCase):
    ...
    def test_print_summary_behavior(self):
        ...
        # Verify log directory is present in the success panel
        self.assertIn(str(reporter.log_dir), str(args[0].renderable))
        ...
        # Verify log directory is present in the failure panel
        self.assertIn(str(reporter.log_dir), str(args[0].renderable))
