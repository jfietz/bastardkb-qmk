...
## 2024-05-07 - Add TimeRemaining estimate for batch operations
**Learning:** For long-running batch operations, users experience wait anxiety. Adding a time remaining estimate alongside the elapsed time significantly improves the CLI UX by setting clear expectations.
**Action:** Always include TimeRemainingColumn in rich.progress bars for tasks with a known total count.
