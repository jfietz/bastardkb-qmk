...
## 2024-05-18 - Estimated Time Remaining for Firmware Batch Builds
**Learning:** For batch processes that build many artifacts (like multiple keyboard firmwares), users benefit greatly from seeing an estimated time remaining, making the system feel more predictable and reducing anxiety about process completion times.
**Action:** Always include a time remaining indicator when using progress bars for long-running batch operations.
