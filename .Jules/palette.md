...
## 2024-05-29 - [TimeRemainingColumn for long-running batch operations]
...
**Action:** When using `rich.progress` for long-running operations, include a `TimeRemainingColumn`.
