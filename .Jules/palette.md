...
## 2026-04-12 - Add Estimated Time to Progress Bar
**Learning:** Including a TimeRemainingColumn alongside TimeElapsedColumn for long-running batch operations helps reduce user wait anxiety and provides better UX.
**Action:** Always include estimated completion times for prolonged, multi-step operations like compiling firmware.
