...
## 2024-05-29 - [Time Remaining Estimate Visibility]
**Learning:** Users experience wait anxiety during long-running batch CLI operations (like compiling multiple firmwares). While elapsed time is helpful, providing an estimated time remaining reduces uncertainty.
**Action:** When using rich.progress for long-running batch operations, include a TimeRemainingColumn alongside TimeElapsedColumn to improve the wait experience.
