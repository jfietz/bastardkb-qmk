...
## 2024-05-29 - [Estimated Completion Time]
**Learning:** Long-running batch CLI processes without time estimates cause wait anxiety. Adding a TimeRemainingColumn alongside TimeElapsedColumn sets clear expectations and improves user confidence.
**Action:** When implementing progress bars for batch processes, always include a time remaining estimate if supported by the UI library.
