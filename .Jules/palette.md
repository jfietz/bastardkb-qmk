...
## 2024-05-29 - [Progress UX for Batch Operations]
...
**Action:** When creating progress bars for operations with many steps (like building firmwares), add `TimeRemainingColumn()` to the `Progress` instantiation so users have a clear expectation of remaining time.
