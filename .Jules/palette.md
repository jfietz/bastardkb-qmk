...
## 2024-05-29 - [Progress Indication and Wait Anxiety]
...
**Action:** Always include a `TimeRemainingColumn` in progress bars for batch processes that take a significant amount of time.
