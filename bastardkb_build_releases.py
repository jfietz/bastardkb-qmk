...
FIRMWARE_COPY_PATTERN = re.compile(r"Copying (?P<filename>[\w\-\.]+) to qmk_firmware folder")
...
def build(
    ...
    total_firmware_count = sum(len(fw_list.configurations) for fw_list in firmwares)
