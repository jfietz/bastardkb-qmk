...
class Executor(object):
    ...
    def qmk_compile(self, firmware: Firmware, worktree: Worktree) -> QmkCompletedProcess:
        ...
        argv = (
            ...
            "--env",
            "USE_CCACHE=yes",
            # Optimization: Use itertools.chain to flatten env_vars without creating intermediate lists
...
def build(
    ...
    # Optimization: Use sum with generator expression to avoid creating intermediate lists
