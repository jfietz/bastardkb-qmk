...
class Executor(object):
    ...
    def qmk_compile(self, firmware: Firmware, worktree: Worktree) -> QmkCompletedProcess:
        ...
        # We omit --clean to allow incremental builds, relying on make/ccache for correctness.
        argv = (
            "qmk",
            "compile",
            "--parallel",
            ...
            "--env",
            "USE_CCACHE=yes",
            # Use chain instead of reduce/iconcat for better performance/readability
